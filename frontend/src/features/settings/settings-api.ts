...
export function getEgressReport(): Promise<{ total: number; healthy: number; unhealthy: number }> {
...
export function testAllEgressNodes(): Promise<{ passed: number; failed: number; total: number }> {
