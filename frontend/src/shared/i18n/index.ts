  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        cleanupStart: "开始清理",
        validateAllEnabled: "校验全部已启用",
        validatePreselect: "预选校验",
        validatePreselectTitle: "预选校验",
        validatePreselectDescription: "将自动从池中选取最多 5 个候选账号执行探测校验。",
        validatePreselectCompleted: "已校验 {{preselected}} / {{poolSize}} 个候选账号",
        deleteAll: "全部删除",
        deleteAllTitle: "删除全部 {{count}} 个账号？",
        deleteAllDescription: "将永久删除当前渠道下的全部账号，此操作无法恢复。",
        deleteAllConfirm: "确认删除",
      },
      proxies: {
        title: "出口代理",
        description: "按 Grok Build、Grok Web、Grok Console、Web 资源作用域独立管理代理节点与健康状态。代理地址和 Cloudflare Cookie 仅写入，不回显。",
        testAll: "测试全部",
        batchImport: "批量导入",
        add: "添加节点",
        saved: "代理节点已保存",
        ...
        editTitle: "编辑代理节点",
        addTitle: "添加代理节点",
        dialogDescription: "Build 节点只配置代理并沿用 Provider 的 User-Agent；Web 与 Console 节点使用各自的浏览器 User-Agent 和 Cloudflare Cookie。",
        multiScopeHint: "一个节点可同时服务多个作用域；账号绑定的代理会按账号隔离。",
        proxyURL: "代理地址",
        proxyProtocols: "支持 HTTP、HTTPS、SOCKS4、SOCKS4A、SOCKS5、SOCKS5H。",
        proxyList: "代理列表",
        userAgent: "User-Agent",
        cloudflareCookie: "Cloudflare Cookie",
        keepConfigured: "已配置，留空保持不变",
        randomUserAgent: "随机",
        randomUserAgentHint: "从常用浏览器 UA 池中随机选取，覆盖现有输入。",
        test: "测试代理",
        testPassed: "{{name}} 测试通过（{{ms}} ms）",
        testFailed: "{{name}} 测试失败：{{error}}",
        testAllDone: "批量测试完成：通过 {{passed}}，失败 {{failed}}，共 {{total}}",
        batchImported: "批量导入完成：新增 {{created}} 个，失败 {{failed}} 个",
        batchCleared: "已清除 {{count}} 个节点的错误状态",
        batchImportTitle: "批量导入代理节点",
        batchImportDescription: "支持明文或 Base64 代理列表，每行一个 HTTP 或 SOCKS 地址；#n 会替换为序号。",
        batchImportAction: "导入 {{count}} 个",
        batchNameHint: "留空时使用默认前缀，导入时自动追加序号。",
        batchNamePreview: "预览：{{preview}}（共 {{count}} 个）",
        batchProxyHint: "每行一个代理地址，支持 socks5h://user:pass@host:port 或 https://host:port 形式。",
        lastProbeOk: "{{ms}} ms · {{time}}",
        lastProbeFail: "{{error}} · {{time}}",
        report: {
          nodes: "节点",
          nodesHint: "已启用 {{proxy}} 个代理节点，其中 {{healthy}} 个健康",
          successRate: "成功率",
          successHint: "{{count}} / {{total}} 次成功",
          failureRate: "失败率",
          failureHint: "{{count}} / {{total}} 次失败",
          requests: "请求数",
          requestsHint: "所有启用节点的累计请求数",
        },
        errors: {
          antiBot: "触发反爬验证",
          transport: "传输层错误",
