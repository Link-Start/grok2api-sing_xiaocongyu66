...
func (r *etagSyncResolver) GetConfiguredPublicIDCandidates(context.Context, string) ([]modeldomain.Route, error) {
	return nil, repository.ErrNotFound
}
...
func (r *etagSyncResolver) GetConfiguredByProviderUpstream(context.Context, account.Provider, string) (modeldomain.Route, error) {
	return modeldomain.Route{}, repository.ErrNotFound
}
