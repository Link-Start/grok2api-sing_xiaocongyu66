...
func TestUpdatePersistsAppliesAndReportsRestart(t *testing.T) {
	...
	input.Batch = BatchConfig{ImportConcurrency: 26, ConversionConcurrency: 27, SyncConcurrency: 28, RefreshConcurrency: 29, RandomDelay: "750ms", DBBuffer: DBBufferConfig{Enabled: false, Driver: "none", Path: ""}}
